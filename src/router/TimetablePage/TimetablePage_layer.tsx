...
/*
day: number;  //0~6: 요일 (일요일~토요일)
start: number;  //시작 시간 (8~23)
end: number;  //종료 시간 (start < end <= 24)
subject: string;  //과목명 또는 활동명
color: string;  //표시 색상 (예: "#93c5fd")
*location?: string  //(선택)위치, 장소 포함시  
*/
